...
%load("sequence_valence1.mat") 
%sequence=1;

%load("sequence_valence2.mat")
%sequence=2;

%%load("sequence_valence3.mat") 
sequence=3;
...
data_path=[current_path,'/data_valence/'];
...
task_id = 'Behavior_valence';%newest_datafile(1:3);
subj_ID = 100;
...
if dummymode == 0
    FileName = ['Behavior_valence',num2str(subj_ID),'.mat'];
elseif dummymode == 1
    FileName = ['Behavior_valence',num2str(subj_ID),'.mat'];
end
