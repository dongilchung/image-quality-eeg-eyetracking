...
%load("sequence_arousal1.mat") %subj 8,9
%sequence=1;

%load("sequence_arousal2.mat")
%sequence=2;

load("sequence_arousal3.mat") %subj 10,11
sequence=3;
...
task_id = 'LG_arousal_pilot';%newest_datafile(1:3);
subj_ID = 100;
...
if dummymode == 0
    FileName = ['LG_',num2str(subj_ID),'_arousal_pilot_EEG.mat'];
elseif dummymode == 1
    FileName = ['LG',num2str(subj_ID),'_arousal_pilot.mat'];
end
